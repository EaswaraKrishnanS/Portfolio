      ...
      <div className="container">
        ...
        <div className="sidebar">
          <ul>
            ...
            <li onClick={() => handleSectionClick('Work History')}>Work History</li>
            <li onClick={() => handleSectionClick('Programming Skills')}>Programming Skills</li>
        ...
        <div className="content">
          {activeSection === 'Education' && (
            <div>
              <h2>Education</h2>
              <div>
              <h5>Periyar Maniammai Institute of Science & Technology , Vallam Thanjavur</h5>
          ...
          {activeSection === 'Work History' && (
            <div>
              ...
              <p>I worked as an Internship Trainee from June 2024 to the present, gaining invaluable hands-on experience in full stack web development. This role allowed me to apply my technical skills in a professional setting, working on a variety of web projects and collaborating with a talented team of developers</p>
            </div>
          )}
          ...
          {activeSection === 'Projects' && (
            <div>
              ...
              <p>The project aims to create a facial expression recognition system with a music recommendation feature to enhance user interaction and emotional response</p>
            </div>
          )}
